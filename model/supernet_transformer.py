...
class TransformerEncoderLayer(nn.Module):
    ...
    def __init__(self, dim, num_heads, mlp_ratio=4., qkv_bias=False, qk_scale=None, dropout=0., attn_drop=0.,
                 ...
                 relative_position=False, change_qkv=False, max_relative_position=14, rank_ratio=0.9):
        super().__init__()
        ...
        self.attn = AttentionSuper(
            ...
            max_relative_position=max_relative_position, rank_ratio=self.rank_ratio
        )
        ...
        mlp_rank = int(min(self.super_embed_dim, self.super_ffn_embed_dim_this_layer) * rank_ratio)

        self.fc11 = LinearSuper(super_in_dim=self.super_embed_dim, super_out_dim=mlp_rank, bias=False)
        self.fc12 = LinearSuper(super_in_dim=mlp_rank, super_out_dim=mlp_rank, bias=False)
        self.fc13 = LinearSuper(super_in_dim=mlp_rank, super_out_dim=self.super_ffn_embed_dim_this_layer)
        
        self.fc21 = LinearSuper(super_in_dim=self.super_ffn_embed_dim_this_layer, super_out_dim=mlp_rank, bias=False)
        self.fc22 = LinearSuper(super_in_dim=mlp_rank, super_out_dim=mlp_rank, bias=False)
        self.fc23 = LinearSuper(super_in_dim=mlp_rank, super_out_dim=self.super_embed_dim)
    ...
    def set_sample_config(self, is_identity_layer, sample_embed_dim=None, sample_mlp_ratio=None, sample_num_heads=None, sample_dropout=None, sample_attn_dropout=None, sample_out_dim=None):
        ...
        sample_mlp_rank = int(min(self.sample_embed_dim, self.sample_ffn_embed_dim_this_layer) * self.rank_ratio)
        ...
        self.fc11.set_sample_config(sample_in_dim=self.sample_embed_dim, sample_out_dim=sample_mlp_rank)
        self.fc12.set_sample_config(sample_in_dim=sample_mlp_rank, sample_out_dim=sample_mlp_rank)
        self.fc13.set_sample_config(sample_in_dim=sample_mlp_rank, sample_out_dim=self.sample_ffn_embed_dim_this_layer)

        self.fc21.set_sample_config(sample_in_dim=self.sample_ffn_embed_dim_this_layer, sample_out_dim=sample_mlp_rank)
        self.fc22.set_sample_config(sample_in_dim=sample_mlp_rank, sample_out_dim=sample_mlp_rank)
        self.fc23.set_sample_config(sample_in_dim=sample_mlp_rank, sample_out_dim=self.sample_out_dim)
